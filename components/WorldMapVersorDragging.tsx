...
export const WorldMapVersorDragging = () => {
  const width = 960;
  ...
  useEffect(() => {
    ...
    const draw = async () => {
      const projection: d3.GeoProjection = d3.geoOrthographic().clipAngle(90); // creates a new orthographic projection function, which simulates a view of the globe from an infinite distance, and sets the clip angle to 90 degrees to ensure that only the front hemisphere of the globe is visible
